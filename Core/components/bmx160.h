 ...
 * @version 0.1
 * @date 2023-01-14
 * @note labrary based on DFRobot's library
 *
...
#define ERROR_CHECK(check)  do {if(check != HAL_OK) uint8_t lala = 0;} while(false)
